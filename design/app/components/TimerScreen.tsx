...
type Sound = { id: string; label: string; icon: React.ReactNode; color: string };
const SOUNDS: Sound[] = [
...
/** Progress ring SVG */
function ProgressRing({ progress, color, isBreak }: { progress: number; color: string; isBreak: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', width: 340, height: 340 }}>
        <ProgressRing progress={progress} color={color} isBreak={phase === 'break'} />
        <div
          style={{
            position: 'absolute',
            inset: 0,
...
export function TimerScreen() {
  ...
  const [time, setTime] = useState(WORK_DURATIONS['25/5']);
  ...
  return (
    <>
      ...
      >
          ...
          {(['fixed', 'flexible'] as Mode[]).map((m) => (
            <button
              ...
              style={{
                ...
                opacity: phase !== 'idle' && mode !== m ? 0.4 : 1,
        ...
        >
          <ProgressRing progress={progress} color={ringColor} isBreak={phase === 'break'} />
